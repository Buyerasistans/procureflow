// FILE: web/src/pages/StrategicPartnerLoginPage.tsx
...
export default function StrategicPartnerLoginPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : "Giri�x ba�xarısız.";
      setError(message);
    } finally {
      setSubmitting(false);
    }
        ...
        >
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <p style={{ margin: 0, maxWidth: 560, fontSize: 16, lineHeight: 1.7, color: "#dbe4ea" }}>
              Stratejik partnerlari yonetir, kendi tenant alanlarina erisir. Kultur, alt yapilar, satis kanallar ve platform dusmani butunlugunu kontrol ederiz.
            </p>
          </div>
        </div>
        ...
        <div style={{ padding: "52px 44px" }}>
          <div style={{ maxWidth: 420, margin: "0 auto" }}>
            <div style={{ marginBottom: 28 }}>
              <div style={{ fontSize: 12, fontWeight: 800, letterSpacing: 2.2, textTransform: "uppercase", color: "#21453d" }}>
              ...
              <p style={{ margin: 0, fontSize: 14, lineHeight: 1.7, color: "#64748b" }}>
                Stratejik partnerlar bu ekran uzerinden yonetim panelesine erisir ve kendi calisma alanlarini kontrol eder.
              </p>
            </div>
            ...
            <div style={{ marginTop: 18, borderRadius: 22, border: "1px solid #e2e8f0", background: "#f8fafc", padding: "16px 18px", color: "#475569", fontSize: 14, lineHeight: 1.7 }}>
              Stratejik partner hesabiniz varsa bu ekrandan giris yapabilirsiniz.
            </div>
          </div>
        </div>
      </div>
