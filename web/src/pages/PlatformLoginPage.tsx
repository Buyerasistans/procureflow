        ...
        >
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <p style={{ margin: 0, maxWidth: 560, fontSize: 16, lineHeight: 1.7, color: "#dbe4ea" }}>
              Platform yoneticileri ve super admin kullanicilari giris sonrasinda merkezi platform arayuzu uzerinden tum kiracilari ve calisma alanlarina erisir.
            </p>
          </div>
        </div>
          ...
          <div style={{ maxWidth: 420, margin: "0 auto" }}>
            <div style={{ marginBottom: 28 }}>
              ...
              <p style={{ margin: 0, fontSize: 14, lineHeight: 1.7, color: "#64748b" }}>
                Platform yoneticileri ve super admin kullanicilari bu ekran uzerinden sistem ayarlarini ve tum kiracilari yonetir.
              </p>
            </div>
            ...
            <div style={{ marginTop: 18, borderRadius: 22, border: "1px solid #e2e8f0", background: "#f8fafc", padding: "16px 18px", color: "#475569", fontSize: 14, lineHeight: 1.7 }}>
              Platform yoneticisi hesabiniz varsa bu ekrandan giris yapabilirsiniz.
            </div>
          </div>
        </div>
      </div>
